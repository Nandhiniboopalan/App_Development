    ...
    return(
        ...
        <div className="center">
          <div className="box">
            ...
            <img className="side" src={heart}></img>
              <p>liked by nandhini...</p>
              <h6>_.acshaya._ : Spanish company and image bank with its own production company that offers more than 10 million graphic resources</h6>
            </div>
          </div>
          <div className="box">
            <div className="top">
